...
export default function Footer() {
  return (
    <footer className="bg-slate-800 p-2 border border-slate-900 flex flex-col">
      ...
      <div className="flex flex-col gap-4 text-sm mt-4">
        <span className="text-slate-400">A ZENITH CREDIT, registrado sob a razão social: PP Promotora de Vendas S.A., inscrita no CNPJ/ME sob o nº 55.395.267/0001-17 com sede em São Paulo, no Estado de São Paulo é um prestador de serviços atuante como correspondente bancário, nos termos da Resolução CMN nº 4.935 de 2021 (“Correspondente no país”), cadastrado em diversas instituições financeiras que poderão ser confirmadas e consultadas através dos canais de Atendimento ( WhatsApp: +55 11 99118-4877 e Email: atendimento@zenithcredit.com.br ).</span>
