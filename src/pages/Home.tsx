...
export default function Home() {
  ...
  return (
    ...
    {/* Sessão 2 */}
    <section id="services" className="flex flex-col p-2 m-0 items-center justify-around text-center w-full bg-gradient-to-r from-blue-900 to-blue-400">
    <h2 className="text-3xl mb-4 text-white">Nossos serviços</h2>
      <ul className="flex flex-col lg:flex-row gap-1">
        ...
        {/* Sessão 3 */}
      <section className="bg-slate-900 m-0">
        <div className="text-center m-4 lg:m-40 md:m-20">
        ...
        <h1 className="text-3xl mb-4 text-zinc-600 mt-2">Nossos parceiros</h1>
          ...
          <div className="flex flex-col m-4 w-full items-center">
            <div className="grid grid-cols-2 gap-6">
              {parceiros.map(p => (
                <img className="h-24 bg-blue-300 p-4 rounded-lg" src={p.url} alt={p.alt} />
              ))}
            </div>
          </div>
        </section>
